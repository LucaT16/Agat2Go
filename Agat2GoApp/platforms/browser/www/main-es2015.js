...
const routes = [
    ...
    { path: 'tabs', loadChildren: () => __webpack_require__.e(/*! import() | tabs-tabs-module */ "tabs-tabs-module").then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(m => m.TabsPageModule) },
...
let ProfilePage = class ProfilePage {
    constructor(authService, router, profileService, alertCtrl, modalController, nativeStorage) {
...
let FirebaseService = class FirebaseService {
    constructor(afs, afAuth, profileService) {
        this.afs = afs;
        this.afAuth = afAuth;
        this.profileService = profileService;
        this.profileService.getUserProfile().then(profile$ => {
